    ...
    <section className="relative isolate overflow-hidden bg-surface">
      ...
      <div className="relative mx-auto flex w-full max-w-5xl flex-col items-center px-6 pb-16 pt-24 text-center sm:pb-32 sm:pt-36">
        ...
        <div className="animate-in mt-3" style={{ animationDelay: "0.08s" }}>
          <h1 className="scroll-expand text-6xl font-semibold tracking-tight text-foreground sm:text-8xl">
            天生会背
          </h1>
        </div>
        <p
          className="animate-in mt-6 max-w-xl text-xl font-medium leading-snug text-foreground-muted sm:text-2xl"
