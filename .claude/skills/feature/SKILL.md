---
name: feature
description: 评估并实现 tsz 的成型新功能，先核对已有能力、完成需求与技术设计，再按已确认方案实施和验证。用于新页面、业务流程或跨包能力；不用于小修复、文案、样式或技能文档维护。 兼容入口，规则复用本仓库 .agents 技能。
---

# feature 项目入口

执行前读取 [项目 feature 技能](../../../.agents/skills/feature/SKILL.md)，并按其中要求读取相关引用文件。
